...
export default function FilterCertificationsBtn({ name, handleClick, type }) {
  ...
  const className = [
    'relative inline-flex min-h-10 w-fit select-none items-center rounded-full border px-4 py-2 text-[0.84rem] font-medium leading-none tracking-[-0.01em] shadow-[0_14px_30px_-24px_var(--color-shadow-md)] transition-all duration-200 ease-out focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-primary-soft',
    isSelected
