...
export default function SectionIntro({
  ...
  const Heading = as;
  const shouldShowEyebrow = showEyebrow && Boolean(eyebrow);
  ...
  return (
    ...
    >
      ...
      <ScrollReveal
        ...
        amount={0.3}
        className={[
          'max-w-[11.5ch] text-balance text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[0.98] tracking-[-0.055em] text-copy-strong min-[790px]:max-w-[14ch]',
          shouldShowEyebrow ? 'mt-5 min-[500px]:mt-7' : '',
          titleClassName,
        ].join(' ').trim()}
      >
        {title}
