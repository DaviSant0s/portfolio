export default function ScreenTransparentBtn({ link, github, name, stacks=[] }) {
  const actionClassName = 'inline-flex h-[clamp(26px,8%,30px)] min-w-[clamp(96px,42%,130px)] items-center justify-center rounded-md border border-white/45 bg-white/10 px-4 text-[clamp(0.72rem,1.2vw,0.82rem)] font-medium leading-none text-copy-inverse no-underline transition-all duration-300 ease-out hover:scale-[1.05] hover:bg-white/15 focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-white/30';
